...
print("Em primeiro lugar, escreve um docuemnto .txt\nNeste devem constar em cada linha: distância percorrida,vírgula,litros gastos.")
...
try:
    ...
    baixo = int(input("Das linhas que preencheste no teu documento, escolhe aquela em que queres iniciar o trajeto\n(se selecionares 0, o trajeto começará da distancia 0): "))
    alto = int(input("Escolhe agora a linha onde queres acabar o trajeto: "))
    ...
    if alto > baixo:
     ...
     print("O consumo total da viagem foi:",litros_gastos,"litros","\nE percorreste",distancia_percorrida,"km.")
        ...
        print("\nO primeiro valor é igual ao segundo.")
    else:
